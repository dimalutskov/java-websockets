    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            if (path == null) {
                ...
                EntityDesc desc = new EntityDesc(GameConstants.ENTITY_TYPE_SPACESHIP,
                ...
                GameObject entity = new GameEntity(ServerApp.instance().getWorld(), id, desc,
                ...
                if (entity == null) {
                    ...
                    if (entity instanceof GameEntity) {
                        GameEntity.State state = ((GameEntity) entity).getState();
