...
public class GameProtocol {
     ...
     * {MSG_TYPE};{SERVER_FRAME_TIME};{OBJECT_STATE};{OBJECT_STATE};...{OBJECT_STATE};
     ...
     * {MSG_TYPE};{SERVER_FRAME_TIME};{OBJECT_STATE};
     */
     ...
     * {MSG_TYPE};{SERVER_FRAME_TIME};{SKILL_ID};{OBJECT_ID};...{OBJECT_ID};
     */
     ...
     * {MSG_TYPE};{SERVER_FRAME_TIME};{x};{y};{angle};{speed}
     */
    public static final String CLIENT_MSG_MOVEMENT = "move";

    /**
     * Provides player skill attributes
     * {MSG_TYPE};{SERVER_FRAME_TIME};{skillID};{skillParams};
     */
